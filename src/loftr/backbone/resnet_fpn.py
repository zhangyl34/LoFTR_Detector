...
class ResNetFPN_8_2(nn.Module):
    ...
    def forward(self, x):
        ...
        # (2N,128,H/2,W/2)
        x2 = self.layer2(x1)  # 1/4，跳层连接
        # (2N,196,H/4,W/4)
        x3 = self.layer3(x2)  # 1/8，跳层连接
        # (2N,256,H/8,W/8)
        ...
        # (2N,256,H/4,W/4)
        x2_out = self.layer2_outconv2(x2_out+x3_out_2x)  # 跳层连接
        # (2N,196,H/4,W/4)
        ...
        # (2N,256,H/2,W/2)
        x1_out = self.layer1_outconv2(x1_out+x2_out_2x)  # 跳层连接
        # (2N,128,H/2,W/2)
